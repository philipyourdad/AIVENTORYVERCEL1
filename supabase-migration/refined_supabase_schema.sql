-- Refined AIventory Database Schema for Supabase (PostgreSQL)
-- This schema addresses issues in the existing schema and ensures compatibility with Vercel and Railway deployments
...
CREATE TABLE staff (
    ...
    staff_role VARCHAR(255) NOT NULL DEFAULT 'Staff',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    last_login TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
